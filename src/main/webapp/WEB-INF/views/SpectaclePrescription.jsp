		...
		<div class="prescription-container">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="row" align="right" style="font-weight: bold;">Vitreoretina Surgeon</div>
					<div class="row" align="right">Above Nokia Priority,Tower Road</div>
			...
			<div class="row">
				...
				<div class="col-md-8" align="left">
					<input class="form-control input-sm prescription-input" name="name"/>
				</div>
				<div class="col-md-1 label-text">Date</div>
				<div class="col-md-2" align="left">
					<input class="form-control input-sm prescription-input" name="date"/>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-md-11" align="left">
					<input class="form-control input-sm prescription-input" name="address"/>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="row">
					<div class="col-md-3">Type of glasses</div>
					<div class="col-md-3">
				...
				<br/>
				<div class="row">
					<div class="col-md-3" style="font-weight: bold;">Any Procedure</div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-1" align="left"></div>
					<div class="col-md-2" align="left">Right Eye</div>
					<div class="col-md-3" align="left">
						<input class="form-control input-md"/>
					</div>
					<div class="col-md-2" align="left">Left Eye</div>
					<div class="col-md-3" align="left">
						<input class="form-control input-md"/>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<input disabled="disabled" class="form-control input-sm prescription-input" name="address"/>
				</div>
			</div>
		</div>
	</div>
