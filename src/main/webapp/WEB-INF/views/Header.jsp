	...
	<nav>
		<ul class="nav nav-justified">
			...
			<%-- <li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="${pageContext.request.contextPath}/patient/add">IPD Bill</a></li>
					<li><a href="${pageContext.request.contextPath}/patient/add">Discharge Card</a></li>
					<li><a href="${pageContext.request.contextPath}/patient/add">Discharge Summary</a></li>
					<li><a href="${pageContext.request.contextPath}/patient/add">O.T Patient List</a></li>
		...
		<%-- 	<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="${pageContext.request.contextPath}/patient/add">Daily Job Sheet (IPD)</a></li>
					<li><a href="${pageContext.request.contextPath}/patient/add">Datewise Search</a></li>
					<li><a href="${pageContext.request.contextPath}/patient/add">Set IPD Fees</a></li>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="${pageContext.request.contextPath}/patient/add">Help</a></li>
				</ul>
			</li>
